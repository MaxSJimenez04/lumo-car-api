  ...
  async up (queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert('Usuario',[
      ...
      {id: crypto.randomUUID(), usuario: 'EnriquePerez', contrasena: await bcrypt.hash('password1234', 10), nombre: 'Enrique', apellidos: 'Pérez González', 
        correo: 'enrpergnz@lumocar.com', telefono: '+523113503156', fecha_nacimiento: new Date(2000, 11, 21), idRol: 2, createdAt: new Date(), updatedAt:new Date()},
      {id: crypto.randomUUID(), usuario: 'BrendaMarquez', contrasena: await bcrypt.hash('password1234', 10), nombre: 'Brenda', apellidos: 'Marquéz Venegas', 
        correo: 'brndmarq@lumocar.com', telefono: '+523562161157', fecha_nacimiento: new Date(1999, 3, 6), idRol: 2, createdAt: new Date(), updatedAt:new Date()},
      {id: crypto.randomUUID(), usuario: 'Pedro Torres', contrasena: await bcrypt.hash('password1234', 10), nombre: 'Pedro', apellidos: 'Torres Gutierrez', 
        correo: 'pdrtorr@lumocar.com', telefono: '+525912304678', fecha_nacimiento: new Date(2000, 11, 21), idRol: 2, createdAt: new Date(), updatedAt:new Date()},
